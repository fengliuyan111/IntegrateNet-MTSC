...
from error import *
from IntegrateNet_EnhancedConv import *
...
def main(lamda, seg_weight=0.0, eval_with_mask=True):
    ...
    val_loader = DataLoader(
        ...
        shuffle=False,
        num_workers=4,
        pin_memory=False  # Disabled to avoid OOM on large images
    )
    ...
    print("="*60)
    print(f"Model: IntegrateNet with Enhanced DoubleConv")
    ...
    for epoch in range(num_epoch):
        ...
        if epoch % 100 == 99:
            save_checkpoint(state,"results/models/IntegrateNet_EnhancedConv", filename='model_ckpt'+str(epoch)+'.pth.tar')

        # save best model parameters and results
        if net.measure['plots_mae'][-1] <= best_mae:
            save_checkpoint(state, "results/models/IntegrateNet_EnhancedConv", filename='model_best.pth')
    ...
    plt.savefig("Loss_seg_EnhancedConv.png", dpi=300)
    plt.close()
