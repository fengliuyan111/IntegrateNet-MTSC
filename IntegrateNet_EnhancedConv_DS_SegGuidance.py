...
# ==================== IntegrateNet with Deep Supervision + Seg-Logits Guidance ====================
class IntegrateNet(nn.Module):
    """
    改进策略：深度监督 + Seg-Logits引导
    
    核心思路：
    1. EnhancedDoubleConv（残差+CBAM）
...
if __name__ == '__main__':
    print("="*60)
    print("IntegrateNet - EnhancedConv + DS + SegGuidance")
    print("="*60)
    ...
    print("\n改进策略组合:")
    print("1. ✓ EnhancedDoubleConv (残差 + CBAM)")
