    ...
    with torch.no_grad():
        for i, sample in enumerate(val_loader):
            ...
            if eval_with_mask and (seg_logits is not None) and (mask is not None):
                ...
                # plot-level metrics: GT/pred plot matching + per-region counting
...
def main(lamda, seg_weight=0.0, eval_with_mask=True):
    ...
    print("="*60)
    print(f"Model: IntegrateNet")
    print(f"Trainable parameters: {trainable_params_m:.4f} M")
    print("="*60)
    ...
    plt.savefig("Loss_seg.png", dpi=300)
    plt.close()
